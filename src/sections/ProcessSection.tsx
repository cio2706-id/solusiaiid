...
const ProcessSection = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Headline from RIGHT (different from Problem section)
      scrollTl.fromTo(
        headlineRef.current,
        { x: '50vw', opacity: 0 },
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="/process_tech_workspace.jpg"
          alt="Tech Workspace"
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-6 lg:px-16 xl:px-24">
        ...
        >
          Tool digital
          <br />
          <span className="text-grayblue">tersebar, tapi</span>
          <br />
          <span className="text-teal">tidak terintegrasi.</span>
        </h2>
        ...
        >
          Data terpecah, waktu terbuang, peluang terlewat. 
          <span className="text-white"> Kami menyatukan alur kerja Anda.</span>
        </p>
      </div>
